#!/usr/bin/env python3
"""
Simple script to help enable GitHub Security features.
This script provides clear instructions and checks.
"""
...
def get_repo_info():
    ...
    stdout, stderr = run_command("gh repo view --json owner,name,url")
    if stdout:
        try:
...
def main():
    """Main function."""
    print("GitHub Security Setup Helper")
    print("=" * 40)
