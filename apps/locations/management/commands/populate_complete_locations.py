...
from apps.locations.models import City, Country, Season, State
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        seasons_data = [
            # Estados Unidos - MLB
            {
                "name": "MLB Temporada Regular 2023",
                "year": 2023,
                "season_type": "regular",
                "start_date": date(2023, 3, 30),
                "end_date": date(2023, 10, 1),
                "status": "completed",
                "description": "Temporada regular de Major League Baseball 2023",
                "total_games": 162,
                "teams_count": 30,
                "league": "Major League Baseball",
            },
            {
                "name": "MLB Temporada Regular 2024",
                "year": 2024,
                "season_type": "regular",
            ...
            {
                "name": "MLB Temporada Regular 2025",
                "year": 2025,
                "season_type": "regular",
            ...
            {
                "name": "MLB Postemporada 2024",
                "year": 2024,
                "season_type": "playoffs",
                "start_date": date(2024, 10, 1),
                "end_date": date(2024, 10, 31),
                "status": "completed",
                "description": "Postemporada de Major League Baseball 2024",
                "total_games": 41,
                "teams_count": 12,
                "league": "Major League Baseball",
            },
            {
                "name": "MLB Postemporada 2025",
                "year": 2025,
                "season_type": "playoffs",
                "start_date": date(2025, 10, 1),
                "end_date": date(2025, 10, 31),
                "status": "upcoming",
                "description": "Postemporada de Major League Baseball 2025",
                "total_games": 41,
                "teams_count": 12,
                "league": "Major League Baseball",
            },
            ...
            {
                "name": "Liga Mexicana 2023",
                "year": 2023,
                "season_type": "regular",
                "start_date": date(2023, 4, 7),
                "end_date": date(2023, 8, 20),
                "status": "completed",
                "description": "Temporada 2023 de la Liga Mexicana de Béisbol",
                "total_games": 114,
                "teams_count": 18,
            ...
            # Colombia - Liga Profesional
            {
                ...
                "status": "completed",
                "description": "Temporada 2023 de la Liga Profesional de Béisbol de Colombia",
                "total_games": 60,
                "teams_count": 8,
                "league": "Liga Profesional de Béisbol de Colombia",
            },
            {
            ...
            {
                "name": "Serie Mundial 2024",
                "year": 2024,
                "season_type": "world_series",
                "start_date": date(2024, 10, 25),
                "end_date": date(2024, 11, 2),
                "status": "completed",
                "description": "Serie Mundial de Major League Baseball 2024",
                "total_games": 7,
                "teams_count": 2,
                "league": "Major League Baseball",
            },
            {
                "name": "Serie Mundial 2025",
                "year": 2025,
                "season_type": "world_series",
                "start_date": date(2025, 10, 24),
                "end_date": date(2025, 11, 1),
                "status": "upcoming",
                "description": "Serie Mundial de Major League Baseball 2025",
                "total_games": 7,
                "teams_count": 2,
                "league": "Major League Baseball",
            },
            {
                "name": "Juego de Estrellas 2024",
                "year": 2024,
                "season_type": "all_star",
                "start_date": date(2024, 7, 16),
                "end_date": date(2024, 7, 16),
                "status": "completed",
                "description": "Juego de Estrellas de Major League Baseball 2024",
                "total_games": 1,
                "teams_count": 2,
                "league": "Major League Baseball",
            },
            {
                "name": "Juego de Estrellas 2025",
                "year": 2025,
                "season_type": "all_star",
                "start_date": date(2025, 7, 15),
                "end_date": date(2025, 7, 15),
                "status": "upcoming",
                "description": "Juego de Estrellas de Major League Baseball 2025",
                "total_games": 1,
                "teams_count": 2,
                "league": "Major League Baseball",
            },
            {
                "name": "Clásico Mundial 2023",
                "year": 2023,
                "season_type": "international",
                "start_date": date(2023, 3, 8),
                "end_date": date(2023, 3, 21),
                "status": "completed",
                "description": "Clásico Mundial de Béisbol 2023",
                "total_games": 47,
                "teams_count": 20,
                "league": "World Baseball Classic",
            },
            {
                "name": "Clásico Mundial 2026",
                "year": 2026,
                "season_type": "international",
                "start_date": date(2026, 3, 6),
                "end_date": date(2026, 3, 19),
                "status": "upcoming",
                "description": "Clásico Mundial de Béisbol 2026",
                "total_games": 47,
                "teams_count": 20,
                "league": "World Baseball Classic",
            },
        ...
        for season_data in seasons_data:
            season, created = Season.objects.get_or_create(
                name=season_data["name"], year=season_data["year"], defaults=season_data
            )
            if created:
