...
class Site(models.Model):
    ...
    address_2 = models.CharField(max_length=200, blank=True, verbose_name="Address 2", help_text="Dirección secundaria (opcional)")
    city = models.ForeignKey('City', on_delete=models.SET_NULL, null=True, blank=True, related_name='sites', verbose_name="City", help_text="Ciudad")
    state = models.ForeignKey('State', on_delete=models.SET_NULL, null=True, blank=True, related_name='sites', verbose_name="State")
    postal_code = models.CharField(max_length=20, verbose_name="Postal Code", help_text="Código postal")
    country = models.ForeignKey('Country', on_delete=models.SET_NULL, null=True, blank=True, related_name='sites', verbose_name="Country")
    
    # Información adicional
    website = models.URLField(blank=True, verbose_name="Website", help_text="Sitio web del lugar")
    additional_info = models.TextField(blank=True, verbose_name="Additional Info", help_text="Información adicional sobre el sitio (ej. Reglas del parque)")
    
    # Imágenes
    image = models.ImageField(upload_to='sites/', blank=True, null=True, verbose_name="Site Image", help_text="Imagen principal del sitio")
