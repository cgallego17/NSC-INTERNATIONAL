...
from apps.locations.models import Country, State, City, Season, Site
...
class EventForm(forms.ModelForm):
    ...
    class Meta:
        model = Event
        fields = [
            'season', 'title', 'short_name', 'description', 'tags',
                 'city', 'state', 'country', 'primary_site', 'additional_sites', 'rule', 'stature',
            'start_date', 'end_date', 'entry_deadline',
            'allow_withdrawals', 'withdraw_deadline', 'freeze_rosters', 'roster_freeze_date',
            'default_entry_fee', 'payment_deadline', 'accept_deposits', 'default_deposit_amount',
            'allow_online_pay', 'has_gate_fee', 'gate_fee_type', 'gate_fee_amount',
            'send_payment_reminders', 'payment_reminder_date', 'accept_schedule_requests', 'schedule_request_deadline'
        ]
        widgets = {
            ...
            'primary_site': forms.Select(attrs={
                'class': 'form-select',
                'placeholder': 'Select Primary Site'
            }),
            'additional_sites': forms.CheckboxSelectMultiple(attrs={
                'class': 'additional-sites-checkbox-list'
            }),
            ...
            'entry_deadline': forms.DateInput(attrs={
                'class': 'form-control',
                'type': 'date',
                'required': True,
                'placeholder': 'dd/mm/aaaa'
            }),
            'allow_withdrawals': forms.CheckboxInput(attrs={
                'class': 'form-check-input'
            }),
            'withdraw_deadline': forms.DateInput(attrs={
                'class': 'form-control',
                'type': 'date'
            }),
            'freeze_rosters': forms.CheckboxInput(attrs={
                'class': 'form-check-input'
            }),
            'roster_freeze_date': forms.DateInput(attrs={
                'class': 'form-control',
                'type': 'date'
            }),
            'default_entry_fee': forms.NumberInput(attrs={
                'class': 'form-control',
                'step': '0.01',
                'placeholder': '0.00'
            }),
            ...
            'accept_deposits': forms.CheckboxInput(attrs={
                'class': 'form-check-input'
            }),
            'default_deposit_amount': forms.NumberInput(attrs={
                'class': 'form-control',
                'step': '0.01',
                'placeholder': '0.00'
            }),
            'allow_online_pay': forms.CheckboxInput(attrs={
                'class': 'form-check-input'
            }),
            'has_gate_fee': forms.CheckboxInput(attrs={
                'class': 'form-check-input'
            }),
            'gate_fee_type': forms.Select(attrs={
                'class': 'form-select'
            }),
            'gate_fee_amount': forms.NumberInput(attrs={
                'class': 'form-control',
                'step': '0.01',
                'placeholder': '0.00'
            }),
            'send_payment_reminders': forms.CheckboxInput(attrs={
                'class': 'form-check-input'
            }),
            'payment_reminder_date': forms.DateInput(attrs={
                'class': 'form-control',
                'type': 'date'
            }),
            'accept_schedule_requests': forms.CheckboxInput(attrs={
                'class': 'form-check-input'
            }),
            'schedule_request_deadline': forms.DateInput(attrs={
                'class': 'form-control',
                'type': 'date'
            }),
        }
