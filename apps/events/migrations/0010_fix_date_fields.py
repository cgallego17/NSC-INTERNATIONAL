...
def fix_date_fields(apps, schema_editor):
    ...
    raw_db = sqlite3.connect(db_path, detect_types=0)  # detect_types=0 disables type detection
    ...
    try:
        ...
        cursor.execute("SELECT id, CAST(start_date AS TEXT) as start_date, CAST(end_date AS TEXT) as end_date FROM events_event")
