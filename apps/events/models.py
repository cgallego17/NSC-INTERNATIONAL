...
class Event(models.Model):
    ...
    short_name = models.CharField(max_length=100, blank=True, verbose_name="Event Short Name", 
    ...
    season = models.ForeignKey('locations.Season', on_delete=models.SET_NULL, null=True, blank=True, related_name='events', verbose_name="Season")
    country = models.ForeignKey('locations.Country', on_delete=models.SET_NULL, null=True, blank=True, related_name='events', verbose_name="Country")
    state = models.ForeignKey('locations.State', on_delete=models.SET_NULL, null=True, blank=True, related_name='events', verbose_name="State")
    city = models.ForeignKey('locations.City', on_delete=models.SET_NULL, null=True, blank=True, related_name='events', verbose_name="City")
    
    # Sitio primario del evento
    primary_site = models.ForeignKey('locations.Site', on_delete=models.SET_NULL, null=True, blank=True, 
                                   related_name='primary_events', verbose_name="Primary Site",
                                   help_text="Sitio principal donde se realizará el evento")
    
    # Sitios adicionales del evento
    additional_sites = models.ManyToManyField('locations.Site', blank=True, related_name='additional_events', 
    ...
    rule = models.ForeignKey('locations.Rule', on_delete=models.SET_NULL, null=True, blank=True, related_name='events', verbose_name="Rule Set")
    ...
    # Tarifas y pagos
    default_entry_fee = models.DecimalField(max_digits=10, decimal_places=2, verbose_name="Default Entry Fee", null=True, blank=True)
    ...
    default_deposit_amount = models.DecimalField(max_digits=10, decimal_places=2, verbose_name="Default Deposit Amount", null=True, blank=True)
    ...
    gate_fee_type = models.CharField(max_length=20, choices=GATE_FEE_TYPE_CHOICES, null=True, blank=True, verbose_name="Gate Fee Type")
    gate_fee_amount = models.DecimalField(max_digits=10, decimal_places=2, verbose_name="Gate Fee Amount", null=True, blank=True)
