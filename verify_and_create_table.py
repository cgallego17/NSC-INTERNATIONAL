#!/usr/bin/env python
"""Script para verificar y crear la tabla events_eventcontact"""
import sqlite3
import sys
...
try:
    ...
    if result:
        ...
        conn.commit()
        print("✓ Tabla events_eventcontact creada exitosamente")
        ...
        if cursor.fetchone():
            ...
            print("✗ Error: Tabla no se creó correctamente")
            sys.exit(1)
    ...
    if "event_contact_id" not in existing_cols:
        print("Agregando campo event_contact_id a events_event...")
